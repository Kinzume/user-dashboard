...
/**
 *
 * @param color Sets the `color` and `bgcolor` of the trophy SVG using MUI5's `alpha` utility function
 * @returns A trophy SVG
 */
export default function TrophySvg({ color }: Props): JSX.Element {
  return (
    <SvgIcon
      sx={{
        lineHeight: 0,
